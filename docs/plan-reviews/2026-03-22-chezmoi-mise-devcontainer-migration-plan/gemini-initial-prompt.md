        ...
        Reviewer role: Gemini acting as an independent adversarial reviewer
        Findings ID prefix: GEMINI
...
- **Separation of concerns**: Are responsibilities cleanly divided, or is
        ...
        In `## Findings`, use numbered bullets and assign stable IDs like `GEMINI-1`.
